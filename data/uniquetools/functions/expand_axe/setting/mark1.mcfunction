#> uniquetools:expand_axe/setting/mark1
#
...
# 通知
  execute unless score @s uniquetools.config.expand_axe_mark1.size matches 1 unless score @s uniquetools.config.expand_axe_mark1.size matches 3 run function uniquetools:expand_axe/setting/error_correction
