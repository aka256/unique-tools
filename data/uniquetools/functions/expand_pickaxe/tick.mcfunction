...
# function実行
  ...
  execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].uniquetools.core{get_target_block:{success:true}} as @s[tag=uniquetools.use.expand_pickaxe] run function uniquetools:expand_pickaxe/use
