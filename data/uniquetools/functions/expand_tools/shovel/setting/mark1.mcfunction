#> uniquetools:expand_tools/shovel/setting/mark1
#
...
# 通知
  execute unless score @s uniquetools.config.expand_shovel_mark1.size matches 1 unless score @s uniquetools.config.expand_shovel_mark1.size matches 3 run function uniquetools:expand_tools/shovel/setting/error_correction
