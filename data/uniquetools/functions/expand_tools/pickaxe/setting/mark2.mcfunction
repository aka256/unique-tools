#> uniquetools:expand_tools/pickaxe/setting/mark2
#
...
# 通知
  execute unless score @s uniquetools.config.expand_pickaxe_mark2.size matches 1 unless score @s uniquetools.config.expand_pickaxe_mark2.size matches 3 unless score @s uniquetools.config.expand_pickaxe_mark2.size matches 5 run function uniquetools:expand_tools/pickaxe/setting/error_correction
