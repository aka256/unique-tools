...
# ターゲットブロックの中心とその面を指すエンティティを設置
  execute positioned ^ ^ ^-0.05 align xyz positioned ~0.5 ~0.5 ~0.5 run summon marker ~ ~ ~ {Tags:["uniquetools.core.get_target_block.surface", "uniquetools.not_has_id_entity"], PortalCooldown:1}
  execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon marker ~ ~ ~ {Tags:["uniquetools.core.get_target_block.center", "uniquetools.not_has_id_entity"], PortalCooldown:1}
