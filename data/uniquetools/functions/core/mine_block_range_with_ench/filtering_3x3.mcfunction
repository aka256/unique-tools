...
execute at @s run loot replace entity 1000-0-1000-0-100000001000 armor.head mine ^-1 ^-1 ^ diamond_pickaxe{Enchantments:[{id:"minecraft:silk_touch",lvl:1s}]}
data modify storage uniquetools.__temp__:core/mine_block_range_with_ench __temp__.source_block set from entity 1000-0-1000-0-100000001000 ArmorItems[3].id
...
execute at @s run loot replace entity 1000-0-1000-0-100000001000 armor.head mine ^-1 ^0 ^ diamond_pickaxe{Enchantments:[{id:"minecraft:silk_touch",lvl:1s}]}
data modify storage uniquetools.__temp__:core/mine_block_range_with_ench __temp__.source_block set from entity 1000-0-1000-0-100000001000 ArmorItems[3].id
...
execute at @s run loot replace entity 1000-0-1000-0-100000001000 armor.head mine ^0 ^-1 ^ diamond_pickaxe{Enchantments:[{id:"minecraft:silk_touch",lvl:1s}]}
data modify storage uniquetools.__temp__:core/mine_block_range_with_ench __temp__.source_block set from entity 1000-0-1000-0-100000001000 ArmorItems[3].id
