#> uniquetools:expand_shovel/setting/mark2
#
...
# 通知
  execute unless score @s uniquetools.config.expand_shovel_mark2.size matches 1 unless score @s uniquetools.config.expand_shovel_mark2.size matches 3 unless score @s uniquetools.config.expand_shovel_mark2.size matches 5 run function uniquetools:expand_shovel/setting/error_correction
